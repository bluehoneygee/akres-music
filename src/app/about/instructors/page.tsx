    ...
    <main className="bg-[#f5f5f5]">
      ...
      <section className="flex h-screen w-full items-center px-6 pt-16 md:pt-20">
        <div className="mx-auto w-full max-w-7xl">
          ...
          <p className="mb-6 text-center text-sm text-zinc-900/75 md:text-base">Meet Our Music Instructors</p>
            ...
            {instructors.map((instructor) => (
              ...
              >
                ...
                <div className="pointer-events-none absolute inset-x-0 bottom-4 translate-y-6 text-center opacity-0 transition-all duration-500 group-hover:pointer-events-auto group-hover:translate-y-0 group-hover:opacity-100">
                  <h2 className="truncate text-sm font-semibold tracking-tight text-zinc-900">{instructor.name}</h2>
                  <p className="mt-1 truncate text-[11px] font-medium tracking-wide text-zinc-900/80">{instructor.role}</p>
                  <Link
                    className="mt-3 inline-flex rounded-full bg-zinc-900 px-3 py-1.5 text-[11px] font-semibold text-white transition hover:bg-zinc-800"
