  ...
  return (
    <main className="bg-white">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        <video autoPlay className="block h-full w-full object-cover" loop muted playsInline preload="metadata">
          <source
            src="https://res.cloudinary.com/djusa1ywh/video/upload/f_auto,q_auto:best,w_1920,c_fill/v1779789890/WhatsApp_Video_2026-05-26_at_14.12.45_1_ohf7os.mp4"
            type="video/mp4"
          />
        </video>
