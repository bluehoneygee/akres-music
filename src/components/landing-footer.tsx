...
export function LandingFooter() {
  return (
    <footer className="bg-zinc-950 px-4 py-16 text-white">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="mt-8 flex justify-center gap-6 text-2xl">
          <Link className="transition-colors hover:text-zinc-300" href="https://instagram.com">
            <Music2 />
          </Link>
          <Link className="transition-colors hover:text-zinc-300" href="https://youtube.com">
            <PlayCircle />
          </Link>
          <Link className="transition-colors hover:text-zinc-300" href="https://facebook.com">
            <Globe />
          </Link>
        </div>
      </div>
